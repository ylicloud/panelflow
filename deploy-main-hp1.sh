...
#   chmod +x deploy-main-hp1.sh   # 首次
#   ./deploy-main-hp1.sh          # 查看步骤说明
#   ./deploy-main-hp1.sh 0        # 完整部署
#   ./deploy-main-hp1.sh 2        # 仅执行第 2 步
...
run_all_steps() {
    echo -e "${GREEN}========== PanelFlow 开始部署（正式机 $SERVER_HOST） ==========${NC}"
    ensure_prereqs
    step_1
    step_2
    step_3
